...
const styles = `
    ...
    * { -webkit-tap-highlight-color: transparent; outline: none; box-sizing: border-box; transition: background-color 0.3s, color 0.3s, border-color 0.3s; }
    ...
    .support-float { 
        ...
        box-shadow: var(--shadow); z-index: 99990; transition: 0.3s; font-size: 20px; 
    ...
    .cookie-banner { 
        ...
        border-top: 3px solid var(--primary); color: var(--text-main); display: none; 
    }
...
const translations = {
    en: { 
        settingsTitle: "Language", cookieTitle: "Privacy Policy", cookieText: "We use cookies.", cookieAccept: "Accept", cookieReject: "Deny", supportBtn: "Support", 
    ...
    ar: { 
        settingsTitle: "اللغة", cookieTitle: "الخصوصية", cookieText: "نستخدم الكوكيز.", cookieAccept: "موافقة", cookieReject: "رفض", supportBtn: "دعم", 
    ...
    ru: { 
        settingsTitle: "Язык", cookieTitle: "Приватность", cookieText: "Cookie.", cookieAccept: "Принять", cookieReject: "Отклонить", supportBtn: "Поддержка", 
